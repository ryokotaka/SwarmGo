...
sys.path.insert(0, str(ROOT.parent / 'SwarmGo/benchmarks/arrival'))
...
manifest = {
    ...
    'swarmgo_source': subprocess.check_output(['git', 'rev-parse', 'HEAD'], cwd=ROOT.parent/'SwarmGo', text=True).strip(),
